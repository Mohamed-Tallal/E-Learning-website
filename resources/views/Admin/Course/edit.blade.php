    ...
    <div class="main-container">
        <div class="card">
            <center>
             ...
             <form action="{{route('Course-page.update',$courses->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                {{method_field('put')}}
                <label for="name">Course Name : </label><br>
                <input type="text" id="Course Name" value="{{$courses->name}}" name="name"><br>
                    @error('name')
                ...
                <input type="file" id="Course Photo"  name="img"><br>
                 ...
                 <input type="text" id="Small Description" value="{{$courses->smail_des}}" name="smail_des"><br>
                     @error('smail_des')
                         <small style="color: #c82333 !important; ">
                             {{$message}}<br><br>
                         </small>
                 ...
                 <textarea id="Description" name="describe" >{{$courses->describe}}</textarea>
                     @error('describe')
                         <small style="color: #c82333 !important; ">
                             {{$message}}<br><br>
                         </small>
